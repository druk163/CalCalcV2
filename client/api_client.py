...
class ApiClient:
    ...
    def register(self, username, password, age=None, weight=None, height=None, gender=None):
    ...
    def get_products(self, search=""):
        return requests.get(f"{self.base_url}/products/", params={"search": search})
    ...
    def get_daily_summary(self, date):
        user_id = self.current_user["id"]
        return requests.get(f"{self.base_url}/meals/daily/{user_id}/{date}")
